...
func NewLevelDBStorage(path string, logger *zap.SugaredLogger) (Storage, error) {
...
// PrismaStorage is a k/v storage using PrismaClient
type PrismaStorage struct {
	client *db.PrismaClient
	ctx    context.Context
}

// PrismaBatch is a batch write for PrismaClient
type PrismaBatch struct {
	client *db.PrismaClient
	ctx    context.Context
	ops    []batchOperation
}
