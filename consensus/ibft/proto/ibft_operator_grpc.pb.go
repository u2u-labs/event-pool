...
func (c *ibftOperatorClient) GetSnapshot(ctx context.Context, in *SnapshotReq, opts ...grpc.CallOption) (*Snapshot, error) {
	...
	out := new(Snapshot)
	err := c.cc.Invoke(ctx, IbftOperator_GetSnapshot_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *ibftOperatorClient) Propose(ctx context.Context, in *Candidate, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, IbftOperator_Propose_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *ibftOperatorClient) Candidates(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*CandidatesResp, error) {
	...
	err := c.cc.Invoke(ctx, IbftOperator_Candidates_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *ibftOperatorClient) Status(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*IbftStatusResp, error) {
	...
	err := c.cc.Invoke(ctx, IbftOperator_Status_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedIbftOperatorServer must be embedded to have
...
func (UnimplementedIbftOperatorServer) testEmbeddedByValue()                      {}
...
func RegisterIbftOperatorServer(s grpc.ServiceRegistrar, srv IbftOperatorServer) {
	// If the following call pancis, it indicates UnimplementedIbftOperatorServer was
