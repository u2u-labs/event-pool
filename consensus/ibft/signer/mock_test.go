...
type MockKeyManager struct {
	...
	GenerateCommittedSealsFunc func(sealsByValidator map[types.Address][]byte, vals validators.Validators) (Seals, error)
	VerifyCommittedSealsFunc   func(seals Seals, hash []byte, vals validators.Validators) (int, error)
