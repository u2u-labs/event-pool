...
// NewNullSugaredLogger returns a zap.SugaredLogger that discards all logs
func NewNullSugaredLogger() *zap.SugaredLogger {
	nullLogger := zap.New(zapcore.NewNopCore())
	return nullLogger.Sugar()
}

// NewTestSugaredLogger returns a zap.SugaredLogger that discards all logs
